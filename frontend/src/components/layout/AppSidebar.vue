...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/quality-checks', label: '降智检查', icon: SignalIcon },
    { path: '/admin/codex-tickets', label: t('admin.settings.gatewayForwarding.ticketPageTitle'), icon: TicketIcon },
