export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        ticketPageTitle: '292 Tickets',
        ticketPageDescription: 'Manage ticket renewal, proxies and automatic refill in one place.',
        ticketHeroTitle: 'Automatic renewal, ready for requests',
        ticketHeroDescription: 'Maintain tickets for each account and model, renewing them before expiry.',
        ticketEnabled: 'Enabled',
        ticketPaused: 'Paused',
        ticketLoading: 'Loading status',
        ticketSwitch: 'Enable automatic harvesting',
        ticketStock: 'Proxies in pool',
        ticketStockHint: 'Used in rotation',
        ticketRemoved: 'Total removed',
        ticketRemovedHint: 'Removed after failed attempts',
        ticketRenewal: 'Renew before expiry',
        ticketMinutes: '{minutes} min',
        ticketRenewalHint: 'Start fetching when this much time remains',
        ticketRefill: 'Automatic refill',
        ticketRefillHint: 'Request 2,000 when the pool is empty',
        ticketSupply: 'Add proxies',
        ticketSupplyDescription: 'Fetch through the API or import your existing proxies.',
        ticketApiTab: 'API fetch',
        ticketManualTab: 'Bulk import',
        ticketRules: 'Current rules',
        ticketRenewRule: 'Renew with {minutes} minutes remaining',
        ticketRenewRuleHint: 'A successfully fetched ticket replaces the previous one.',
        ticketRemoveRule: 'Remove after {count} failed attempt(s)',
        ticketRemoveRuleHint: 'Based on ticket results; successful proxies are kept.',
        ticketRefillRule: 'Refill when the pool is empty',
        ticketRefillDisabledHint: 'Currently paused. Enable and save it in the proxy supply panel.',
        ticketRefillRuleHint: 'Request 2,000 per batch. Wait 60 seconds before retrying a failed refill.',
        ticketBackground: 'Tasks run on the server and continue with this page closed.',
        ticketUpdated: 'Updated {time} · Refreshes every 15 seconds',
        ticketLoadError: 'Could not load status. Click refresh to try again.',
        ticketSaveError: 'Could not save. Please try again.',
        ticketSaved: 'Settings saved',
        ticketConfigure: 'Configure API',
        ticketCollapse: 'Hide configuration',
        ticketNotConfigured: 'Not configured',
        ticketAdvanced: 'Single proxy settings',
        ticketAdvancedHint: 'Used when no managed pool exists. Save a blank value to keep the configured proxy.',
        ticketAdvancedPlaceholder: 'Enter a full proxy connection URL',
        ticketSaveProxy: 'Save proxy',
        ticketManage: 'Open ticket management',
        ...
        poolTitle: "Bulk import IPs / proxy pool",
        poolRefresh: "Refresh status",
        poolRule: "When 292 ticket harvesting is enabled, proxies rotate in order. A proxy is automatically removed after one failed ticket attempt; successful proxies are kept.",
        poolStatus: "{count} proxies · {removed} automatically removed",
        poolEmpty: "The pool is empty and waiting for proxies. Enable automatic refill and 292 ticket harvesting to fetch in the background, or import proxies manually.",
        poolInput: "Proxy list (one per line)",
        poolFormats: "Accepts IP:port, IP:port:username:password, or HTTP, HTTPS, SOCKS5 and SOCKS5H proxy URLs. Maximum 2000 proxies per import.",
        poolImport: "Bulk import IPs",
        poolImporting: "Importing…",
        poolFile: "Choose TXT file",
        poolImmediate: "Appends unique proxies and saves immediately.",
        poolLoadError: "Cannot load proxy pool status. Click refresh to retry.",
        poolFileTooLarge: "The file must not exceed 2 MB.",
        poolLimit: "Enter 1 to 2000 proxies, one per line.",
        poolSuccess: "Added {added}, skipped {duplicates} duplicates; {count} proxies total.",
        poolImportError: "Import failed. Existing proxies are unchanged.",
        apiTitle: "Fetch through the OnesProxy API",
        apiDescription: "Enter API credentials to fetch and import proxies, or use an existing extraction URL.",
        apiType: "API method",
        apiGenerate: "Account API (Userid / Token)",
        apiExtract: "Existing extraction API URL",
        apiProxyID: "Dynamic proxy ID (proxy_id)",
        apiSecretSaved: "Saved. Leave blank to keep it, or enter a replacement.",
        apiTokenPlaceholder: "Find it in OnesProxy Support Center → API Integration",
        apiCountry: "Country code (blank for random)",
        apiRoute: "Route code (match your plan, or leave blank)",
        apiMode: "Proxy mode",
        apiSticky: "Sticky session",
        apiRotate: "Rotate on each connection",
        apiSession: "Session minutes (within your plan limit)",
        apiURL: "Full extraction URL (including key)",
        apiCount: "Proxies per request",
        apiLimitNote: "Requests 2000 by default; the provider may return fewer. Proxy connections do not guarantee distinct exit IPs.",
        apiAutoRefill: "Automatically refill when the proxy pool is empty",
        apiAutoRefillNote: "Takes effect after saving. With 292 ticket harvesting enabled, an empty pool triggers a background request for 2000 proxies, even with this page closed. At most one automatic fetch per minute; failed attempts retry after 60 seconds.",
        apiFetching: "Fetching and importing…",
        apiFetch: "Fetch and import",
        apiSave: "Save configuration only",
        apiConfigured: "API configured",
        apiLoadError: "Cannot load API configuration. Refresh to retry.",
        apiMissingCredentials: "Enter Userid, Token and the dynamic proxy ID.",
        apiMissingURL: "Enter the full OnesProxy extraction API URL.",
        apiSaved: "API configuration saved.",
        apiSuccess: "Requested {requested}, received {received}; added {added}, skipped {duplicates} duplicates. Pool total: {count}.",
        apiError: "API fetch failed. Existing proxies are unchanged.",
