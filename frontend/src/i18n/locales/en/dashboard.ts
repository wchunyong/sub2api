export default {
  ...
  keys: {
    ...
    quickImport: {
      ...
      ccsHint: 'Manage configuration with CC Switch',
      manualHint: 'View key and configuration instructions',
      directHint: 'System detected automatically · Paste into your terminal to run',
      importCopied: 'Import command copied. Paste into your terminal within 5 minutes.',
      cleanCopied: 'Cleanup command copied. Run in the original import environment.',
      copyFailed: 'Copy failed. Click to retry copying.',
      ...
      generate: 'Generate setup command',
      expiry: 'Valid for 5 minutes and a single redemption. Do not share.',
      resultHint: 'Copy and run in your terminal. The terminal reports the result; copying does not mean installation succeeded.',
      failed: 'Could not generate a command. Check the key, Agent compatibility and HTTPS, then retry.',
      expired: 'Command expired. Generate a new one.',
      ...
      autoHint: 'Back up and configure the selected Agent',
      clean: 'Clean up',
      manual: 'Manual configuration',
      openCcs: 'Open CC Switch',
      ccsOpened: 'Attempted to open CC Switch. Confirm the result in the client.',
      installCcs: 'Install CC Switch',
      comingSoon: 'Scripts are being integrated. Please use manual configuration for now.',
      later: 'Set up later',
    },
    useKey: 'Use Key',
    useKeyModal: {
